...
const tokens = [
  {
    ...
    value: from('16294294218941056819'),
  },
  {
    name: 'BABL -> DAI',
    tokenIn: addresses.tokens.BABL,
    tokenOut: addresses.tokens.DAI,
    value: from('48638075222642794861'),
  },
  {
    name: 'BABL -> USDC',
    tokenIn: addresses.tokens.BABL,
    tokenOut: addresses.tokens.USDC,
    value: from('48370549899053833611'),
  },
  {
    name: 'BABL -> WETH',
    tokenIn: addresses.tokens.BABL,
    tokenOut: addresses.tokens.WETH,
    value: from('18785719760800248'),
  },
  {
    name: 'BABL -> WBTC',
    tokenIn: addresses.tokens.BABL,
    tokenOut: addresses.tokens.WBTC,
    value: from('1232805417946316'),
  },
  {
    name: 'GF->DAI',
    tokenIn: '0xaaef88cea01475125522e117bfe45cf32044e238',
    tokenOut: addresses.tokens.DAI,
    value: from('1549106195372493868'),
  },
  {
    name: 'FRAX->DAI',
  ...
  },
  {
    ...
    value: from('65706220941725753'),
  },
  {
    name: 'WETH->CRV',
    tokenIn: addresses.tokens.WETH,
    tokenOut: addresses.tokens.CRV,
    value: parse('1295.875307441108806091'),
  },
  {
    name: 'WETH->sAAVE',
    tokenIn: addresses.tokens.WETH,
    tokenOut: addresses.tokens.sAAVE,
    value: from('21376766938121335479'),
  },
  {
    name: 'DAI->sAAVE',
    tokenIn: addresses.tokens.DAI,
    tokenOut: addresses.tokens.sAAVE,
    value: from('8208453133373606'),
  },
  {
    name: 'DAI->USDC',
    tokenIn: addresses.tokens.DAI,
  ...
  },
  {
    ...
    tokenOut: addresses.tokens.DAI,
    value: from('19382122564629559527062'),
  },
  {
    name: 'SNX->USDT',
    tokenIn: addresses.tokens.SNX,
    tokenOut: addresses.tokens.USDT,
    value: from('4520520824458085528'),
  },
  {
    name: 'WBTC->DAI',
    tokenIn: addresses.tokens.WBTC,
    tokenOut: addresses.tokens.DAI,
    value: from('40017332515599353306466'),
  },
  {
    name: 'COMP->USDC',
    tokenIn: addresses.tokens.COMP,
    tokenOut: addresses.tokens.USDC,
    value: from('103977074704436839512'),
  },
  {
    name: 'YFI',
    tokenIn: addresses.tokens.WETH,
