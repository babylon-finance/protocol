module.exports = async ({
  ...
  if (!(await controller.isValidReserveAsset('0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2'))) {
    ...
    await (
      await controller.addReserveAsset('0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', { maxPriorityFeePerGas })
    ).wait();
  }
  ...
  if (!(await controller.isValidReserveAsset('0x6B175474E89094C44Da98b954EedeAC495271d0F'))) {
    ...
    await (
      await controller.addReserveAsset('0x6B175474E89094C44Da98b954EedeAC495271d0F', { maxPriorityFeePerGas })
    ).wait();
  }
  ...
  if (!(await controller.isValidReserveAsset('0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48'))) {
    ...
    await (
      await controller.addReserveAsset('0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', { maxPriorityFeePerGas })
    ).wait();
  }
  ...
  if (!(await controller.isValidReserveAsset('0x2260fac5e5542a773aa44fbcfedf7c193bc2c599'))) {
    ...
    await (
      await controller.addReserveAsset('0x2260fac5e5542a773aa44fbcfedf7c193bc2c599', { maxPriorityFeePerGas })
    ).wait();
  }
  ...
  if (!(await controller.isValidReserveAsset('0xf4dc48d260c93ad6a96c5ce563e70ca578987c74'))) {
    ...
    await (
      await controller.addReserveAsset('0xf4dc48d260c93ad6a96c5ce563e70ca578987c74', { maxPriorityFeePerGas })
    ).wait();
  }
  ...
  if (!(await controller.isValidKeeper(KEEPER))) {
    ...
    await (await controller.addKeepers([KEEPER], { maxPriorityFeePerGas })).wait();
  }
