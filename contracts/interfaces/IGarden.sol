...
interface IGarden is IERC20 {
    ...
    function lockContributorStake(address _contributor, uint256 _amount) external;

    function unlockContributorStake(address _contributor, uint256 _amount) external;
