...
contract AaveLendIntegration is LendIntegration {
    ...
    function _getExpectedShares(address /* _assetToken */, uint256 _numTokensToSupply) internal pure override returns (uint256) {
        // love it 😍
        return _numTokensToSupply;
    }

    function _getExchangeRatePerToken(address /* _assetToken */) internal pure override returns (uint256) {
        // love it 😍
        return 1;
    }
