...
abstract contract PassiveIntegration is BaseIntegration, ReentrancyGuard {
    ...
    function _validatePreExitInvestmentData(InvestmentInfo memory _investmentInfo) internal view {
      ...
      require(_investmentInfo.investmentTokensInGarden >= _investmentInfo.investmentTokensInTransaction, "The garden does not have enough investment tokens");
    }
    ...
    function _validatePostEnterInvestmentData(InvestmentInfo memory _investmentInfo) internal view {
      require((IERC20(_investmentInfo.investment).balanceOf(address(_investmentInfo.strategy)) > _investmentInfo.investmentTokensInGarden), "The garden did not receive the investment tokens");
    }
    ...
    function _validatePostExitInvestmentData(InvestmentInfo memory _investmentInfo) internal view {
      require(IERC20(_investmentInfo.investment).balanceOf(address(_investmentInfo.strategy)) == _investmentInfo.investmentTokensInGarden - _investmentInfo.investmentTokensInTransaction, "The garden did not return the investment tokens");
    }
     ...
     * @param _investmentInfo                Struct containing investment information used in internal functions
     */
    function _updateGardenPositions(InvestmentInfo memory _investmentInfo, address _depositToken, bool isDeposit) internal {
