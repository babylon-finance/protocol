...
contract RewardsDistributor is OwnableUpgradeable, IRewardsDistributor {
        ...
        returns (uint256[] memory)
    {
        ...
        if (IStrategy(_strategy).isStrategyActive()) {
            ...
            console.log(
                'contributorShare',
                contributorShare,
                ERC20(garden).balanceOf(_contributor).preciseDiv(ERC20(garden).totalSupply())
            );
        ...
        )
    {
        ...
        if (_garden == _address) {
            ...
            console.log('User route - beta user', _address, betaUser);
        }
    ...
    function _getStrategyProfitsAndBABL(
        ...
        if (strategyDetails[1] > _claimedAt) {
            ...
            console.log(
                'contributorShare',
                contributorShare,
                ERC20(_garden).balanceOf(_contributor).preciseDiv(ERC20(_garden).totalSupply())
            );
            rewards = _getRewardsPerRole(
                _garden,
                _strategy,
