module.exports = {
  ...
  balancer: {
    factoryv1: '0x9424B1412450D0f8Fc2255FAf6046b98213B76Bd',
  },
  curve: {
    ...
    pools: {
      v3: {
        ...
        // 4pool: '0x4e0915C88bC70750D68C481540F081fEFaF22273' RIP
        // 2pool: '0x4e0915C88bC70750D68C481540F081fEFaF22273' no volume
      },
      crypto: {
        ...
        // Broken
        // spell: '0x98638FAcf9a3865cd033F36548713183f6996122', // review
      ...
      factory: {
        ...
        // usdd: '0xe6b5CC1B4b47305c58392CE3D359B10282FC36Ea', // 116
        // stethConcentrated: '0x828b154032950C8ff7CF8085D841723Db2696056', // 117
        // reth: '0x447Ddd4960d9fdBF6af9a790560d0AF76795CB08', // 89 No price
        // dola: '0xAA5A67c256e27A5d80712c51971408db3370927D', // 27
        // Broken
        // usdv: '0x7abD51BbA7f9F6Ae87aC77e1eA1C5783adA56e5c', // 82 No price
        // pwrd: '0xbcb91E689114B9Cc865AD7871845C95241Df4105', // 44
        // pusd: '0x8EE017541375F6Bcd802ba119bdDC94dad6911A1', // 113 No price
        // usdm: '0x5B3b5DF2BF2B6543f78e053bD91C4Bdd820929f1', // 23 No price
        // aleth: '0xC4C319E2D4d66CcA4464C0c2B32c9Bd23ebe784e', // 38 No price
        // mimust: '0x55A8a39bc9694714E2874c1ce77aa1E599461E18', // 48 RPI Luna
        // wormhole: '0xCEAF7747579696A2F0bb206a14210e3c9e6fB269', // 53 RIP Luna fiasco
        // bean: '0x3a70DfA7d2262988064A2D051dd47521E43c9BdD', // 81 (bean died for now. restore it once bean is back?)
      ...
      cryptofactory: {
        // palstkaave: '0x48536EC5233297C367fd0b6979B75d9270bB6B15', // 9 // review
        // yfieth: '0xC26b89A667578ec7b3f11b2F98d6Fd15C07C54ba', // 8
        // btflyeth: '0xF43b15Ab692fDe1F9c24a9FCE700AdCC809D5391', // 17 review
        // badgerwbtc: '0x50f3752289e1456BfA505afd37B241bca23e685d', // 4
        // stgusdc: '0x3211C6cBeF1429da3D0d58494938299C92Ad5860', // 37
        fpifrax: '0xf861483fa7E511fbc37487D91B6FAa803aF5d37c', // 48
        cvxfxs: '0xd658A338613198204DCa1143Ac3F01A722b5d94A', // 18
        // kp3reth: '0x21410232B484136404911780bC32756D5d1a9Fa9', // 39
        // Broken
        // fidueth: '0x80aa1a80a30055DAA084E599836532F3e58c95E2', // 23 No liquidity
        // ohmeth: '0x6ec38b3228251a0C5D491Faf66858e2E23d7728B', // 21 No liquidity
        // stasiseurs: '0x98a7F18d4E56Cfe84E3D081B40001B3d5bD3eB8B',
      },
      gaugeBlacklist: [
        '0x8038C01A0390a8c547446a0b2c18fc9aEFEcc10c', // dusd old crap
        '0x5a6A4D54456819380173272A5E8E9B9904BdF41B', // doesnt have a gauge
        '0xE7a24EF0C5e95Ffb0f6684b813A78F2a3AD7D171', // doesnt have a gauge
        '0x7abD51BbA7f9F6Ae87aC77e1eA1C5783adA56e5c', // doesnt have a gauge
      ],
    },
  },
  gamma: {
  ...
  aladdin: {
    pools: [
      {
        name: 'clever',
        lptoken: '0x4e3FBD56CD56c3e72c1403e103b45Db9da5B9D2B',
      },
      {
        name: 'crv Concentrator',
        lptoken: '0xD533a949740bb3306d119CC777fa900bA034cd52',
      },
      {
        name: 'steth convex',
      ...
      // Disabled
      // cvxfxs (we don't have it on curve, cvx)
      // rocketpool (we don't have the integration)
      // {
      //   name: 'wormhole',
