  ...
  curve: {
    ...
    pools: {
      v3: {
        ...
        // aeth: '0xA96A65c051bF88B4095Ee1f2451C2A9d43F53Ae2', should not be used directly it is better to buy an ankrETH on UNI
        busd: '0x79a8C46DeA5aDa233ABaFFD40F3A0A2B1e5A4F27',
        // compound: '0xA2B47E3D5c44877cca798226B7B8118F9BFb7A56', fails due to NAV PriceOracle issue
        // eurs: '0x98a7F18d4E56Cfe84E3D081B40001B3d5bD3eB8B', No price
        // hbtc: '0x4CA9b3063Ec5866A4B82E437059D2C43d1be596F', No price
        ...
        // susd: '0xA5407eAE9Ba41422680e2e00537571bcC53efBfD',  fails due to NAV PriceOracle issue
        usdt: '0x52EA46506B9CC5Ef470C5bf89f17Dc28bB35D85C',
        // y: '0x45F783CCE6B7FF23B2ab2D70e416cdb7D6055f51',  fails due to NAV PriceOracle issue
