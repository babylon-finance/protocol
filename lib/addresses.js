module.exports = {
  ...
  yearn: {
    ...
    vaults: [
      // { vault: '0xc5bDdf9843308380375a611c18B50Fb9341f502A' }, // veCRV-DAO yVault N/A weird vault. Is the asset of the vault below
      // { vault: '0x9d409a0A012CFbA9B15F6D4B36Ac57A46966Ab9a' }, // yvBOOST
      { vault: '0xdb25cA703181E7484a155DD612b06f57E12Be5F0' }, // YFI yVault
      { vault: '0xF29AE508698bDeF169B89834F76704C3B205aedf' }, // SNX yVault
      { vault: '0x873fB544277FD7b977B196a826459a69E27eA4ea' }, // RAI yVault
      { vault: '0x671a912C10bba0CFA74Cfc2d6Fba9BA1ed9530B2' }, // LINK yVault
      { vault: '0xa5cA62D95D24A4a350983D5B8ac4EB8638887396' }, // sUSD yVault
      { vault: '0xB8C3B7A2A618C552C23B1E4701109a9E756Bab67' }, // 1INCH yVault
      { vault: '0xa258C4606Ca8206D8aA700cE2143D7db854D168c' }, // WETH yVault
      { vault: '0x5f18C75AbDAe578b483E5F43f12a39cF75b973a9' }, // USDC yVault
      { vault: '0xdA816459F1AB5631232FE5e97a05BBBb94970c95' }, // DAI yVault
      { vault: '0xA696a63cc78DfFa1a63E9E50587C197387FF6C7E' }, // WBTC yVault
      { vault: '0x7Da96a3891Add058AdA2E826306D812C638D87a7' }, // USDT yVault
      { vault: '0xFBEB78a723b8087fD2ea7Ef1afEc93d35E8Bed42' }, // UNI yVault
      { vault: '0xd9788f3931Ede4D5018184E198699dC6d66C1915' }, // AAVE yVault
      { vault: '0x4A3FE75762017DB0eD73a71C9A06db7768DB5e66' }, // COMP yVault
      { vault: '0x6d765CbE5bC922694afE112C140b8878b9FB0390' }, // SUSHI yVault
      { vault: '0xFD0877d9095789cAF24c98F7CCe092fa8E120775' }, // TUSD yVault
      { vault: '0xE537B5cc158EB71037D4125BDD7538421981E6AA', curve: true }, // Curve 3Crypto Pool yVault
      { vault: '0x6FAfCA7f49B4Fd9dC38117469cd31A1E5aec91F5', curve: true }, // Curve USDM Pool yVault
      { vault: '0x718AbE90777F5B778B52D553a5aBaa148DD0dc5D', curve: true }, // Curve alETH Pool yVault
      { vault: '0x8b9C0c24307344B6D7941ab654b2Aeee25347473', curve: true }, // Curve EURN Pool yVault
      { vault: '0xd8C620991b8E626C099eAaB29B1E3eEa279763bb', curve: true }, // Curve MIM-UST
      { vault: '0x0d4EA8536F9A13e4FBa16042a46c30f092b06aA5', curve: true }, // Curve EURT Pool yVault
      { vault: '0x2DfB14E32e2F8156ec15a2c21c3A6c053af52Be8', curve: true }, // Curve MIM Pool yVault
      { vault: '0x4560b99C904aAD03027B5178CCa81584744AC01f', curve: true }, // Curve cvxCRV Pool yVault
      { vault: '0x67e019bfbd5a67207755D04467D6A70c0B75bF60', curve: true }, // Curve ibEUR Pool yVault
      { vault: '0x528D50dC9a333f01544177a924893FA1F5b9F748', curve: true }, // Curve ibKRW Pool yVault
      { vault: '0x595a68a8c9D5C230001848B69b1947ee2A607164', curve: true }, // Curve ibGBP Pool yVault
      { vault: '0x1b905331F7dE2748F4D6a0678e1521E20347643F', curve: true }, // Curve ibAUD Pool yVault
      { vault: '0x490bD0886F221A5F79713D3E84404355A9293C50', curve: true }, // Curve ibCHF Pool yVault
      { vault: '0x59518884EeBFb03e90a18ADBAAAB770d4666471e', curve: true }, // Curve ibJPY Pool yVault
      { vault: '0x8cc94ccd0f3841a468184aCA3Cc478D2148E1757', curve: true }, // Curve mUSD Pool yVault
      { vault: '0x625b7DF2fa8aBe21B0A976736CDa4775523aeD1E', curve: true }, // Curve HBTC Pool yVault
      { vault: '0x3D27705c64213A5DcD9D26880c1BcFa72d5b6B0E', curve: true }, // Curve USDK Pool yVault
      { vault: '0x80bbeE2fa460dA291e796B9045e93d19eF948C6A', curve: true }, // Curve Pax Pool yVault
      { vault: '0xC116dF49c02c5fD147DE25Baa105322ebF26Bd97', curve: true }, // Curve RSV Pool yVault
      { vault: '0x28a5b95C101df3Ded0C0d9074DB80C438774B6a9', curve: true }, // Curve USDT Pool yVault
      { vault: '0x3D980E50508CFd41a13837A60149927a11c03731', curve: true }, // Curve triCrypto Pool yVault
      { vault: '0x25212Df29073FfFA7A67399AcEfC2dd75a831A1A', curve: true }, // Curve EURS Pool yVault
      { vault: '0x5a770DbD3Ee6bAF2802D29a901Ef11501C44797A', curve: true }, // Curve sUSD Pool yVault
      { vault: '0x39CAF13a104FF567f71fd2A4c68C026FDB6E740B', curve: true }, // Curve Aave Pool yVault
      { vault: '0x054AF22E1519b020516D72D749221c24756385C9', curve: true }, // Curve HUSD Pool yVault
      { vault: '0x3B96d491f067912D18563d56858Ba7d6EC67a6fa', curve: true }, // Curve USDN Pool yVault
      { vault: '0xBfedbcbe27171C418CDabC2477042554b1904857', curve: true }, // Curve rETH Pool yVault
      { vault: '0x132d8D2C76Db3812403431fAcB00F3453Fc42125', curve: true }, // Curve ankrETH Pool yVault
      { vault: '0xf2db9a7c0ACd427A680D640F02d90f6186E71725', curve: true }, // Curve LINK Pool yVault
      { vault: '0xA74d4B67b3368E83797a35382AFB776bAAE4F5C8', curve: true }, // Curve alUSD Pool yVault
      { vault: '0xC4dAf3b5e2A9e93861c3FBDd25f1e943B8D87417', curve: true }, // Curve USDP Pool yVault
      { vault: '0x1C6a9783F812b3Af3aBbf7de64c3cD7CC7D1af44', curve: true }, // Curve UST Pool yVault
      { vault: '0x30FCf7c6cDfC46eC237783D94Fc78553E79d4E9C', curve: true }, // Curve DUSD Pool yVault
      { vault: '0xf8768814b88281DE4F532a3beEfA5b85B69b9324', curve: true }, // Curve TUSD Pool yVault
      { vault: '0x4B5BfD52124784745c1071dcB244C6688d2533d3', curve: true }, // Curve Y Pool yVault
      { vault: '0x84E13785B5a27879921D6F685f041421C7F482dA', curve: true }, // Curve 3pool yVault
      { vault: '0x2a38B9B0201Ca39B17B460eD2f11e4929559071E', curve: true }, // Curve GUSD Pool yVault
      { vault: '0x27b7b1ad7288079A66d12350c828D3C00A6F07d7', curve: true }, // Curve Iron Bank Pool yVault
      { vault: '0x986b4AFF588a109c09B50A03f42E4110E29D353F', curve: true }, // Curve sETH Pool yVault
      { vault: '0xdCD90C7f6324cfa40d7169ef80b12031770B4325', curve: true }, // Curve stETH Pool yVault
      { vault: '0x8414Db07a7F743dEbaFb402070AB01a4E0d2E45e', curve: true }, // Curve sBTC Pool yVault
      { vault: '0x7047F90229a057C13BF847C0744D646CFb6c9E1A', curve: true }, // Curve renBTC Pool yVault
      { vault: '0xe9Dc63083c464d6EDcCFf23444fF3CFc6886f6FB', curve: true }, // Curve oBTC Pool yVault
      { vault: '0x3c5DF3077BcF800640B5DAE8c91106575a4826E6', curve: true }, // Curve pBTC Pool yVault
      { vault: '0x23D3D0f1c697247d5e0a9efB37d8b0ED0C464f7f', curve: true }, // Curve tBTC Pool yVault
      { vault: '0xB4AdA607B9d6b2c9Ee07A275e9616B84AC560139', curve: true }, // Curve FRAX Pool yVault
      { vault: '0x5fA5B62c8AF877CB37031e0a3B2f34A78e3C56A6', curve: true }, // Curve LUSD Pool yVault
      { vault: '0xb4D1Be44BfF40ad6e506edf43156577a3f8672eC', curve: true }, // Curve SAAVE Pool yVault
      { vault: '0x8fA3A9ecd9EFb07A8CE90A6eb014CF3c0E3B32Ef', curve: true }, // Curve BBTC Pool yVault
      { vault: '0x6Ede7F19df5df6EF23bD5B9CeDb651580Bdf56Ca', curve: true }, // Curve BUSD Pool yVault
      { vault: '0x2994529C0652D127b7842094103715ec5299bBed', curve: true }, // yearn Curve.fi yDAI/yUSDC/yUSDT/yBUSD
      { vault: '0xD6Ea40597Be05c201845c0bFd2e96A60bACde267', curve: true }, // Curve Compound Pool yVault
    ],
  },
  harvest: {
    vaults: {
