module.exports = {
  ...
  yearn: {
    ...
    vaults: [
      ...
      // { vault: '0xa5cA62D95D24A4a350983D5B8ac4EB8638887396', curve: false, name: 'sUSD yVault' }, NO: // Does not work
      // { vault: '0xB8C3B7A2A618C552C23B1E4701109a9E756Bab67', curve: false, name: '1INCH yVault' }, Twap deviation issue
      // { vault: '0x6d765CbE5bC922694afE112C140b8878b9FB0390', curve: false, name: 'SUSHI yVault' }, Twap deviation issue
      // Work
