module.exports = {
  ...
  curve: {
    ...
    pools: {
      ...
      factory: {
        ...
        origindollar: '0x87650D7bbfC3A9F10587d7778206671719d9910D', //
        // Broken
  ...
  gamma: {
    visors: [
      { name: 'BABL-ETH', address: '0x52cE16B1F37Ea7BE4352B29fcDE3331E225380FF' },
  ...
  bonds: [
    { name: 'fDAI', address: '0xa6c25548df506d84afd237225b5b34f2feb1aa07' },
    { name: 'fFRAX', address: '0xa54c548d11792b3d26ad74f5f899e12cdfd64fd6' },
    { name: 'fBABL', address: '0x812eedc9eba9c428434fd3ce56156b4e23012ebc' },
    { name: 'fWETH', address: '0x7dbc3af9251756561ce755fcc11c754184af71f7' },
    { name: 'fFEI', address: '0x3a2804ec0ff521374af654d8d0daa1d1ae1ee900' },
    { name: 'BABL-ETH', address: '0x52cE16B1F37Ea7BE4352B29fcDE3331E225380FF' },
  ],
  pickle: {
    // https://github.com/pickle-finance/contracts
    jars: [
      { name: 'USDC Jar', address: '0xEB801AB73E9A2A482aA48CaCA13B1954028F4c94' },
      {
        name: 'Yearn USDC Jar',
