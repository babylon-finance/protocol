module.exports = {
  ...
  curve: {
    ...
    pools: {
      v3: {
        ...
        // eurs: '0x98a7F18d4E56Cfe84E3D081B40001B3d5bD3eB8B', No price
        hbtc: '0x4CA9b3063Ec5866A4B82E437059D2C43d1be596F',
        ib: '0x2dded6Da1BF5DBdF597C45fcFaa3194e53EcfeAF',
        // link: '0xF178C0b5Bb7e7aBF4e12A4838C7b7c5bA2C623c0', Weird
        ...
        // sbtc: '0x7fC77b5c7614E1533320Ea6DDc2Eb61fa00A9714', No price
        ...
        // linkusd: '0xE7a24EF0C5e95Ffb0f6684b813A78F2a3AD7D171', Weird
        ...
        // bbtc: '0x071c661B4DeefB59E2a3DdB20Db036821eeE8F4b', no price
        // obtc: '0xd81dA8D904b52208541Bade1bD6595D8a251F8dd', no price
        // pbtc: '0x7F55DDe206dbAD629C080068923b36fe9D6bDBeF', no price
        // tbtc: '0xC25099792E9349C7DD09759744ea681C7de2cb66', no price
        tusd: '0xEcd5e75AFb02eFa118AF914515D6521aaBd189F1',
        lusd: '0xEd279fDD11cA84bEef15AF5D39BB4d4bEE23F0cA',
        frax: '0xd632f22692FaC7611d2AA1C0D552930D43CAEd3B',
        busdv2: '0x4807862AA8b2bF68830e4C8dc86D0e9A998e085a',
        // reth: '0xF9440930043eb3997fc70e1339dBb11F341de7A8', no price
        alusd: '0x43b4FdFD4Ff969587185cDB6f0BD875c5Fc83f8c',
        // tricrypto: '0x80466c64868E1ab14a1Ddf27A676C3fcBE638Fe5', old
        tricrypto2: '0xD51a44d3FaE010294C616388b506AcdA1bfAAE46',
        mim: '0x5a6A4D54456819380173272A5E8E9B9904BdF41B',
        // eurt: '0x9838eCcC42659FA8AA7daF2aD134b53984c9427b', no price
      },
    },
  },
  convex: {
  ...
  yearn: {
    ...
    vaults: [
      ...
      // { vault: '0xa5cA62D95D24A4a350983D5B8ac4EB8638887396', curve: false, name: 'sUSD yVault' }, // Does not work. Look into why
      // { vault: '0xB8C3B7A2A618C552C23B1E4701109a9E756Bab67', curve: false, name: '1INCH yVault' }, Twap deviation issue. Probably works on real mainnet
      // { vault: '0x6d765CbE5bC922694afE112C140b8878b9FB0390', curve: false, name: 'SUSHI yVault' }, Twap deviation issue. Probably works on real mainnet
      // Work
      { vault: '0xdb25cA703181E7484a155DD612b06f57E12Be5F0', curve: false, name: 'YFI yVault' },
      { vault: '0xF29AE508698bDeF169B89834F76704C3B205aedf', curve: false, name: 'SNX yVault' },
      { vault: '0x873fB544277FD7b977B196a826459a69E27eA4ea', curve: false, name: 'RAI yVault' },
      { vault: '0x671a912C10bba0CFA74Cfc2d6Fba9BA1ed9530B2', curve: false, name: 'LINK yVault' },
      { vault: '0xa258C4606Ca8206D8aA700cE2143D7db854D168c', curve: false, name: 'WETH yVault' },
      { vault: '0x5f18C75AbDAe578b483E5F43f12a39cF75b973a9', curve: false, name: 'USDC yVault' },
      { vault: '0xdA816459F1AB5631232FE5e97a05BBBb94970c95', curve: false, name: 'DAI yVault' },
      { vault: '0xA696a63cc78DfFa1a63E9E50587C197387FF6C7E', curve: false, name: 'WBTC yVault' },
      { vault: '0x7Da96a3891Add058AdA2E826306D812C638D87a7', curve: false, name: 'USDT yVault' },
      { vault: '0xFBEB78a723b8087fD2ea7Ef1afEc93d35E8Bed42', curve: false, name: 'UNI yVault' },
      { vault: '0xd9788f3931Ede4D5018184E198699dC6d66C1915', curve: false, name: 'AAVE yVault' },
      { vault: '0x4A3FE75762017DB0eD73a71C9A06db7768DB5e66', curve: false, name: 'COMP yVault' },
      { vault: '0xFD0877d9095789cAF24c98F7CCe092fa8E120775', curve: false, name: 'TUSD yVault' },
      // { vault: '0xE537B5cc158EB71037D4125BDD7538421981E6AA', curve: true, name: 'Curve 3Crypto Pool yVault' },
      // { vault: '0x6FAfCA7f49B4Fd9dC38117469cd31A1E5aec91F5', curve: true, name: 'Curve USDM Pool yVault' },
      // { vault: '0x718AbE90777F5B778B52D553a5aBaa148DD0dc5D', curve: true, name: 'Curve alETH Pool yVault' },
      // { vault: '0x8b9C0c24307344B6D7941ab654b2Aeee25347473', curve: true, name: 'Curve EURN Pool yVault' },
      // { vault: '0xd8C620991b8E626C099eAaB29B1E3eEa279763bb', curve: true, name: 'Curve MIM-UST' },
      // { vault: '0x0d4EA8536F9A13e4FBa16042a46c30f092b06aA5', curve: true, name: 'Curve EURT Pool yVault' },
      // { vault: '0x2DfB14E32e2F8156ec15a2c21c3A6c053af52Be8', curve: true, name: 'Curve MIM Pool yVault' },
      // { vault: '0x4560b99C904aAD03027B5178CCa81584744AC01f', curve: true, name: 'Curve cvxCRV Pool yVault' },
      // { vault: '0x67e019bfbd5a67207755D04467D6A70c0B75bF60', curve: true, name: 'Curve ibEUR Pool yVault' },
      // { vault: '0x528D50dC9a333f01544177a924893FA1F5b9F748', curve: true, name: 'Curve ibKRW Pool yVault' },
      // { vault: '0x595a68a8c9D5C230001848B69b1947ee2A607164', curve: true, name: 'Curve ibGBP Pool yVault' },
      // { vault: '0x1b905331F7dE2748F4D6a0678e1521E20347643F', curve: true, name: 'Curve ibAUD Pool yVault' },
      // { vault: '0x490bD0886F221A5F79713D3E84404355A9293C50', curve: true, name: 'Curve ibCHF Pool yVault' },
      // { vault: '0x59518884EeBFb03e90a18ADBAAAB770d4666471e', curve: true, name: 'Curve ibJPY Pool yVault' },
      // { vault: '0x8cc94ccd0f3841a468184aCA3Cc478D2148E1757', curve: true, name: 'Curve mUSD Pool yVault' },
      // { vault: '0x625b7DF2fa8aBe21B0A976736CDa4775523aeD1E', curve: true, name: 'Curve HBTC Pool yVault' },
      // { vault: '0x3D27705c64213A5DcD9D26880c1BcFa72d5b6B0E', curve: true, name: 'Curve USDK Pool yVault' },
      // { vault: '0x80bbeE2fa460dA291e796B9045e93d19eF948C6A', curve: true, name: 'Curve Pax Pool yVault' },
      // { vault: '0xC116dF49c02c5fD147DE25Baa105322ebF26Bd97', curve: true, name: 'Curve RSV Pool yVault' },
      // { vault: '0x28a5b95C101df3Ded0C0d9074DB80C438774B6a9', curve: true, name: 'Curve USDT Pool yVault' },
      // { vault: '0x3D980E50508CFd41a13837A60149927a11c03731', curve: true, name: 'Curve triCrypto Pool yVault' },
      // { vault: '0x25212Df29073FfFA7A67399AcEfC2dd75a831A1A', curve: true, name: 'Curve EURS Pool yVault' },
      // { vault: '0x5a770DbD3Ee6bAF2802D29a901Ef11501C44797A', curve: true, name: 'Curve sUSD Pool yVault' },
      // { vault: '0x39CAF13a104FF567f71fd2A4c68C026FDB6E740B', curve: true, name: 'Curve Aave Pool yVault' },
      // { vault: '0x054AF22E1519b020516D72D749221c24756385C9', curve: true, name: 'Curve HUSD Pool yVault' },
      // { vault: '0x3B96d491f067912D18563d56858Ba7d6EC67a6fa', curve: true, name: 'Curve USDN Pool yVault' },
      // { vault: '0xBfedbcbe27171C418CDabC2477042554b1904857', curve: true, name: 'Curve rETH Pool yVault' },
      // { vault: '0x132d8D2C76Db3812403431fAcB00F3453Fc42125', curve: true, name: 'Curve ankrETH Pool yVault' },
      // { vault: '0xf2db9a7c0ACd427A680D640F02d90f6186E71725', curve: true, name: 'Curve LINK Pool yVault' },
      // { vault: '0xA74d4B67b3368E83797a35382AFB776bAAE4F5C8', curve: true, name: 'Curve alUSD Pool yVault' },
      // { vault: '0xC4dAf3b5e2A9e93861c3FBDd25f1e943B8D87417', curve: true, name: 'Curve USDP Pool yVault' },
      // { vault: '0x1C6a9783F812b3Af3aBbf7de64c3cD7CC7D1af44', curve: true, name: 'Curve UST Pool yVault' },
      // { vault: '0x30FCf7c6cDfC46eC237783D94Fc78553E79d4E9C', curve: true, name: 'Curve DUSD Pool yVault' },
      // { vault: '0xf8768814b88281DE4F532a3beEfA5b85B69b9324', curve: true, name: 'Curve TUSD Pool yVault' },
      // { vault: '0x4B5BfD52124784745c1071dcB244C6688d2533d3', curve: true, name: 'Curve Y Pool yVault' },
      // { vault: '0x84E13785B5a27879921D6F685f041421C7F482dA', curve: true, name: 'Curve 3pool yVault' },
      // { vault: '0x2a38B9B0201Ca39B17B460eD2f11e4929559071E', curve: true, name: 'Curve GUSD Pool yVault' },
      // { vault: '0x27b7b1ad7288079A66d12350c828D3C00A6F07d7', curve: true, name: 'Curve Iron Bank Pool yVault' },
      // { vault: '0x986b4AFF588a109c09B50A03f42E4110E29D353F', curve: true, name: 'Curve sETH Pool yVault' },
      // { vault: '0xdCD90C7f6324cfa40d7169ef80b12031770B4325', curve: true, name: 'Curve stETH Pool yVault' },
      // { vault: '0x8414Db07a7F743dEbaFb402070AB01a4E0d2E45e', curve: true, name: 'Curve sBTC Pool yVault' },
      // { vault: '0x7047F90229a057C13BF847C0744D646CFb6c9E1A', curve: true, name: 'Curve renBTC Pool yVault' },
      // { vault: '0xe9Dc63083c464d6EDcCFf23444fF3CFc6886f6FB', curve: true, name: 'Curve oBTC Pool yVault' },
      // { vault: '0x3c5DF3077BcF800640B5DAE8c91106575a4826E6', curve: true, name: 'Curve pBTC Pool yVault' },
      // { vault: '0x23D3D0f1c697247d5e0a9efB37d8b0ED0C464f7f', curve: true, name: 'Curve tBTC Pool yVault' },
      // { vault: '0xB4AdA607B9d6b2c9Ee07A275e9616B84AC560139', curve: true, name: 'Curve FRAX Pool yVault' },
      // { vault: '0x5fA5B62c8AF877CB37031e0a3B2f34A78e3C56A6', curve: true, name: 'Curve LUSD Pool yVault' },
      // { vault: '0xb4D1Be44BfF40ad6e506edf43156577a3f8672eC', curve: true, name: 'Curve SAAVE Pool yVault' },
      // { vault: '0x8fA3A9ecd9EFb07A8CE90A6eb014CF3c0E3B32Ef', curve: true, name: 'Curve BBTC Pool yVault' },
      // { vault: '0x6Ede7F19df5df6EF23bD5B9CeDb651580Bdf56Ca', curve: true, name: 'Curve BUSD Pool yVault' },
      // { vault: '0x2994529C0652D127b7842094103715ec5299bBed', curve: true, name: 'yearn Curve.fi yDAI/yUSDC/yUSDT/yBUSD' },
      // { vault: '0xD6Ea40597Be05c201845c0bFd2e96A60bACde267', curve: true, name: 'Curve Compound Pool yVault' },
    ],
  },
  harvest: {
    vaults: {
  ...
  holders: {
    ...
    BABL: '0x40154ad8014df019a53440a60ed351dfba47574e',
