...
function getGardenParams({
  ...
  return [
    ...
    !!pricePerShareSlippage ? pricePerShareSlippage : eth(), //Base slippage for price per share
  ];
}
...
const WBTC_GARDEN_PARAMS = getGardenParams({
  maxDepositLimit: eth(1e9),
  minLiquidityAsset: eth(1e5),
  minContribution: eth(1e6),
});
