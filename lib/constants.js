...
const USDC_GARDEN_PARAMS = [
  ethers.BigNumber.from(1e7 * 1e6), // Max Deposit Limit (6 decimals)
...
const WBTC_GARDEN_PARAMS = [
  ...
  1, // Deposit Hardlock | 1 second
  ethers.BigNumber.from(4e6), // Min Contribution
  ONE_DAY_IN_SECONDS, // Strategy Cooldown Period
  ethers.utils.parseEther('0.10'), // Min Voter Quorum | 10%
  ONE_DAY_IN_SECONDS * 3, // Min Strategy Duration
  ONE_DAY_IN_SECONDS * 365, // Max Strategy Duration
...
const BABL_GARDEN_PARAMS = [
  ethers.utils.parseEther('10000'), // Max Deposit Limit
  ethers.utils.parseEther('10000'), // Min Liquidity Asset | ie: Uniswap Volume
  1, // Deposit Hardlock | 1 second
  ethers.utils.parseEther('10'), // Min Contribution
  ONE_DAY_IN_SECONDS, // Strategy Cooldown Period
  ethers.utils.parseEther('0.10'), // Min Voter Quorum | 10%
  ONE_DAY_IN_SECONDS * 3, // Min Strategy Duration
  ONE_DAY_IN_SECONDS * 365, // Max Strategy Duration
...
const STRATEGY_EXECUTE_MAP = {
  ...
  [addresses.tokens.BABL]: eth(30),
  [addresses.tokens.USDC]: from(1000 * 1e6),
  [addresses.tokens.WBTC]: from(15e5), // Below '15e5' amount Uniswap throws 'revert UniswapV2Router: INSUFFICIENT_A_AMOUNT'
};

const PROFIT_PROTOCOL_FEE = 5e16;
const PROTOCOL_FEE = 5e15;
const PROFIT_STRATEGIST_SHARE = ethers.utils.parseEther('0.10'); // 10%
const PROFIT_STEWARD_SHARE = ethers.utils.parseEther('0.05'); // 5%
const PROFIT_LP_SHARE = ethers.utils.parseEther('0.80'); // 80%
