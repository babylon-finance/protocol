...
export async function getContracts() {
  ...
  return { gov, owner, deployer, keeper, controller, distributor, strategyNft, valuer, gardens, gnosis };
}
...
const deployFixture = deployments.createFixture(async (hre, options) => {
  ...
  return { controller, distributor, owner, gov, deployer, keeper, gardens, gardensNAV, strategyNft, valuer, gnosis };
});
