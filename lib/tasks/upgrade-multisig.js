...
task('upgrade-multisig')
  ...
  .setAction(
    async (
      ...
      const { controller, distributor, garden, assistant, strategy, calldata } = args;
      ...
      await client.createProposal({
        ...
        description: `Upgrades ${!!controller ? 'BabController,' : ''} ${!!assistant ? 'Assistant,' : ''} ${!!distributor ? 'RewardsDistributor,' : ''} ${
          !!garden ? 'Garden,' : ''
        } ${!!strategy ? 'Strategy' : ''} proxies`,
        type: 'custom',
